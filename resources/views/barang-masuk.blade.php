            ...
            <div class="card-body">
                ...
                <div id="listAtkWrapper">
                    ...
                    <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#tambahModal">+ Tambah
                        ATK</button>
<a href="{{ route('barang-masuk.pdf') }}" class="btn btn-danger" target="_blank">Download PDF</a>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="listMebelerWrapper">
                        {{-- Button Tambah --}}
                        <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#tambahMebeler">+
                            Tambah
                            Alat</button>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="date" name="tanggal_masuk_alat"
                                                value="{{ $alat->tanggal_masuk_alat }}" class="form-control mb-2"
                                                required>
        ...
        {{-- Modal Tambah --}}
        <div class="modal fade" id="tambahMebeler" tabindex="-1" aria-labelledby="tambahMebelerLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                                            ...
                                            @if ($fotoArray && count($fotoArray) > 0)
                                                @foreach ($fotoArray as $index => $foto)
                                                    <img src="{{ asset('storage/' . $foto) }}" alt="Foto Barang"
                                                        style="width:80px; height:80px; object-fit:cover; margin:2px; cursor:pointer; border-radius: 4px; border: 1px solid #ccc;"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#zoomFotomebelerModal{{ $mebeler->id }}_{{ $index }}">

                                                    <!-- Modal Zoom Foto -->
                                                    <div class="modal fade"
                                                        id="zoomFotomebelerModal{{ $mebeler->id }}_{{ $index }}"
                                                        tabindex="-1"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <input type="text" name="nama_mebeler"
                                                            value="{{ $mebeler->nama_mebeler }}"
                                                            class="form-control mb-2" placeholder="Nama Mebeler" required>

                                                        <input type="number" name="jumlah_mebeler"
                                                            value="{{ $mebeler->jumlah_mebeler }}"
                                                            class="form-control mb-2" placeholder="Jumlah" required>

                                                        <input type="text" name="satuan_mebeler"
                                                            value="{{ $mebeler->satuan_mebeler }}"
                                                            class="form-control mb-2" placeholder="Satuan" required>
                        ...
                        <form action="{{ route('mebeler.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="date" name="tanggal_masuk_mebeler" class="form-control mb-2"
                                        required>
